...
public interface GbDepartmentGoodsStockService {
	
	GbDepartmentGoodsStockEntity queryObject(Integer gbDepartmentGoodsStockId);
	
	List<GbDepartmentGoodsStockEntity> queryList(Map<String, Object> map);
	
	int queryTotal(Map<String, Object> map);
	
	void save(GbDepartmentGoodsStockEntity gbDepartmentGoodsStock);
	
	void update(GbDepartmentGoodsStockEntity gbDepartmentGoodsStock);
	
	void delete(Integer gbDepartmentGoodsStockId);
	
	void deleteBatch(Integer[] gbDepartmentGoodsStockIds);
...
//    Double queryDepStockLossSubtotal(Map<String, Object> map);
    ...
    TreeSet<GbDepartmentEntity> queryDepGoodsTreeDepartments(Map<String, Object> map);
