...
import com.nongxinle.community.catalog.service.NxCommunityGoodsSetPropertyService;
import com.nongxinle.community.catalog.service.NxCommunityGoodsMediaService;
...
import com.nongxinle.community.catalog.service.NxCommunityAliasService;
...
//
    ...
    public R updateComGoods (@RequestBody NxCommunityGoodsEntity nxCommunityGoodsEntity) {
            ...
            BigDecimal fractionalPart = goodsPrice.subtract(goodsPrice.setScale(0, RoundingMode.DOWN)).multiply(new BigDecimal(100)).setScale(0,BigDecimal.ROUND_HALF_UP);
