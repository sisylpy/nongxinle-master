...
public class NxCommunityFatherGoodsController {
    ...
    public R getFatherWithGoods(Integer commId, Integer orderUserId,Integer orderType,
        ...
        if (orderUserId != null && orderUserId > 0 && commId != null) {
            MiniappCartPricingHelper.mergeIntoMap(mapR, cartPricingService, commId, orderUserId,
                    orderType, serviceType, spId);
        } else {
            CartPricingSupport.mergeIntoMap(mapR, CartPricingSupport.emptyPricing());
        }
