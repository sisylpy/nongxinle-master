package com.nongxinle.community.catalog.service.impl;
...
//    }
    ...
    public List<NxCommunityFatherGoodsEntity> queryGrandGoodsWithOrders(Map<String, Object> map) {
		...
		return nxCommunityFatherGoodsDao.queryGrandGoodsWithOrders(map);
    }
...
//    }
    ...
    @Override
    public List<NxCommunityFatherGoodsEntity> queryGrandGoodsWithOrdersDesk(Map<String, Object> map) {

		return nxCommunityFatherGoodsDao.queryGrandGoodsWithOrdersDesk(map);
    }
