...
public class NxCustomerUserCouponController {
    ...
    public R receiveSubOrderCoupon(Integer userId, Integer coupId, Integer shareUserId) {
        ...
        NxCustomerUserCouponEntity userCouponEntity = nxCustomerUserCouponService.equalObject(coupId);
        ...
        nxCustomerUserCouponEntity.setNxCucType(userCouponEntity.getNxCucType());
        System.out.println("newsaafd" + nxCustomerUserCouponEntity);
