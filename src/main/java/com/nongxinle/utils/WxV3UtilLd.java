...
public class WxV3UtilLd {

    /**
     * 读取请求体
     */
    public static String readRequestBody(HttpServletRequest request) throws IOException {
        System.out.println("wxV3UtilLd" + request);
    ...
    /**
     * 验签逻辑示例
     * （具体要看你是否使用微信官方SDK或自己实现）
     */
    public static boolean verifySignature(String body, HttpServletRequest request, String platformCertificate) {
        // 1. 从请求头获取签名相关参数
        ...
        // 3. 使用 platformCertificate(公钥) 校验 wechatpaySignature
        //    下面是伪代码，实际需要把 platformCertificate 解析成 PublicKey 对象
        //    并用 RSA-SHA256 验签
        // ...

        return true; // 根据实际验签结果返回 true/false
    }
     ...
     */
    public static String aesGcmDecrypt(String apiV3Key, String associatedData, String nonce, String ciphertext) throws Exception {
     ...
     * 返回错误
     */
    public static Map<String, String> errorReturn(String msg) {
        System.out.println("wxVeUtlldErooreturn" + msg);
    ...
    public static String sendPostWithCert(String url, String body) throws Exception {
        ...
        // 1. 加载商户私钥（用于签名）
//        String privateKeyPath = "/Users/lpy/cert/laodu/apiclient_key.pem";
        String privateKeyPath = "/opt/nongxinle-cert/laodu/apiclient_key.pem";
        ...
        String serialNo = "423A816587FE3B8D21DBD2B757A9E3DBC7A35676"; // 替换成你实际的证书序列号
        URI uri = new URI(url);
        ...
        post.setHeader("Authorization", String.format(
                ...
                "1694659996", nonceStr, timestamp, serialNo, signature));
...
//        String p12Path = "/Users/lpy/cert/laodu/apiclient_cert.p12";
        String p12Path = "/opt/nongxinle-cert/laodu/apiclient_cert.p12";

        String mchId = "1694659996"; // 证书密码即商户号
