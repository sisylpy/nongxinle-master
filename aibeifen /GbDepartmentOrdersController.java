...
//    private GbDepartmentOrdersEntity choiceGoodsOrder(GbDepartmentOrdersEntity order, GbDistributerGoodsEntity disGoodsEntity) {
...
//
//        order.setGbDoPurchaseGoodsId(disGoodsEntity.getGbDistributerGoodsId());
//
//        order.setGbDoArriveWhatDay(getWeek(0));
//
//
//        Integer nxDoDisGoodsId = order.getGbDoDisGoodsId();
//
//        GbDistributerGoodsEntity nxDistributerGoodsEntity = gbDistributerGoodsService.queryObject(nxDoDisGoodsId);
//
//        GbDepartmentOrdersEntity nxDepartmentOrdersEntity = updateOneOrderForChoice(order, nxDistributerGoodsEntity);
//
//        nxDepartmentOrdersEntity.setGbDistributerGoodsEntity(nxDistributerGoodsEntity);
//        return order;
//    }
...
//            map.put("depId", ordersEntity.getGbDoDepartmentId());
//            map.put("name", ordersEntity.getGbDoGoodsName());
//            map.put("standard", ordersEntity.getGbDoStandard());
//            System.out.println("duoggsshangpsuodepgods11111ddd" + map);
//            List<GbDepartmentDisGoodsEntity> departmentDisGoodsEntitiesFirst = gbDepartmentDisGoodsService.queryDepDisGoodsByParams(map);
//            if (departmentDisGoodsEntitiesFirst.size() == 0) {
//                map.put("name", null);
//                map.put("orderName", ordersEntity.getGbDoGoodsName());
//                System.out.println("duoggsshangpsuodepgods222222ddd" + map);
//                List<GbDepartmentDisGoodsEntity> departmentDisGoodsEntitiesSecond = gbDepartmentDisGoodsService.queryDepDisGoodsByParams(map);
//                if (departmentDisGoodsEntitiesSecond.size() == 0) {
//
//                    //查询 disGoods
//                    String goodsName = ordersEntity.getGbDoGoodsName();
//                    Map<String, Object> mapZero = new HashMap<>();
...
//                        List<GbDistributerGoodsEntity> distributerGoodsEntitiesOne = gbDistributerGoodsService.queryDisGoodsByName(mapZero);
...
//                            mapTwo.put("disId", ordersEntity.getGbDoDistributerId());
//                            mapTwo.put("searchPinyin", pinyinString);
//                            mapTwo.put("standard", ordersEntity.getGbDoStandard());
//                            List<GbDistributerGoodsEntity> disGoodsByNamePinyin = gbDistributerGoodsService.queryDisGoodsByNamePinyin(mapTwo);
...
//                                List<GbDistributerGoodsEntity> disGoodsByNamePinyinJust = gbDistributerGoodsService.queryDisGoodsByNamePinyin(mapTwo);
//                                System.out.println("resultteslsutltlt----pinyinnullStanddrd" + disGoodsByNamePinyinJust.size());
//                                if (disGoodsByNamePinyinJust.size() == 0) {
//                                    List<GbDistributerGoodsEntity> disGoodsByNamePinyinLike = gbDistributerGoodsService.queryDisGoodsByNameLikePinyin(mapTwo);
//                                    if (disGoodsByNamePinyinLike.size() == 0) {
//                                        //查别名
//                                        Map<String, Object> mapA = new HashMap<>();
//                                        mapA.put("disId", ordersEntity.getGbDoDistributerId());
//                                        mapA.put("alias", goodsName);
//                                        List<GbDistributerGoodsEntity> distributerGoodsEntitiesA = gbDistributerGoodsService.queryDisGoodsByAlias(mapA);
//                                        System.out.println("resultteslsutltlt----aila" + distributerGoodsEntitiesA.size());
//                                        // 四级 相同
//                                        if (distributerGoodsEntitiesA.size() == 0) {
//
//                                            List<GbDistributerGoodsEntity> distributerGoodsEntitiesALike = gbDistributerGoodsService.queryDisGoodsByAliasLike(mapTwo);
//
...
//                                                    ordersEntity.setGbDistributerGoodsEntityList(distributerGoodsEntitiesALike);
//                                                    returnList.add(aaaTemp(ordersEntity));
//
//                                                } else {
//                                                    ordersEntity.setGbDistributerGoodsEntityList(distributerGoodsEntitiesALike);
...
//                                                // 1.保存订单
//                                                GbDistributerGoodsEntity disGoodsEntity = distributerGoodsEntitiesA.get(0);
//                                                ordersEntity.setGbDoDisGoodsId(disGoodsEntity.getGbDistributerGoodsId());
//                                                Map<String, Object> mapDep = new HashMap<>();
//                                                mapDep.put("disGoodsId", disGoodsEntity.getGbDistributerGoodsId());
//                                                mapDep.put("depId", ordersEntity.getGbDoDepartmentId());
...
//
//                                            } else {
//                                                ordersEntity.setGbDistributerGoodsEntityList(distributerGoodsEntitiesA);
//                                                returnList.add(aaaTemp(ordersEntity));
//                                            }
//                                        }
//                                    } else {
...
//
//                                            GbDistributerGoodsEntity disGoodsEntity = disGoodsByNamePinyinLike.get(0);
//                                            ordersEntity.setGbDoDisGoodsId(disGoodsEntity.getGbDistributerGoodsId());
//                                            Map<String, Object> mapDep = new HashMap<>();
//                                            mapDep.put("disGoodsId", disGoodsEntity.getGbDistributerGoodsId());
//                                            mapDep.put("depId", ordersEntity.getGbDoDepartmentId());
...
//                                            returnList.add(saveOneOrder(ordersEntity, disGoodsEntity));
//                                        } else {
//                                            ordersEntity.setGbDistributerGoodsEntityList(disGoodsByNamePinyinLike);
//                                            returnList.add(aaaTemp(ordersEntity));
//                                        }
//                                    }
//
...
//                                        GbDistributerGoodsEntity disGoodsEntity = disGoodsByNamePinyinJust.get(0);
//                                        ordersEntity.setGbDoDisGoodsId(disGoodsEntity.getGbDistributerGoodsId());
//
//                                        Map<String, Object> mapDep = new HashMap<>();
//                                        mapDep.put("disGoodsId", disGoodsEntity.getGbDistributerGoodsId());
...
//                                        returnList.add(saveOneOrder(ordersEntity, disGoodsEntity));
//                                    } else {
//                                        System.out.println("duogejainzhenguuggu" + disGoodsByNamePinyinJust.size());
//                                        ordersEntity.setGbDistributerGoodsEntityList(disGoodsByNamePinyinJust);
//                                        returnList.add(aaaTemp(ordersEntity));
//                                    }
//                                }
//                            } else {
...
//                                    //1 保存订单
//                                    GbDistributerGoodsEntity disGoodsEntity = disGoodsByNamePinyin.get(0);
//
//                                    ordersEntity.setGbDoDisGoodsId(disGoodsEntity.getGbDistributerGoodsId());
//
//                                    Map<String, Object> mapDep = new HashMap<>();
...
//                                    ordersEntity.setGbDistributerGoodsEntityList(disGoodsByNamePinyin);
//                                    returnList.add(aaaTemp(ordersEntity));
//                                }
//                            }
////                        ////////
...
//
//                        } else {
//                            System.out.println("pinyinssouocduoo" + distributerGoodsEntitiesOne);
//                            ordersEntity.setGbDistributerGoodsEntityList(distributerGoodsEntitiesOne);
//                            returnList.add(aaaTemp(ordersEntity));
//
//                        }
//
//                    } else {
//                        System.out.println("oneonneneneoneneoendistributerGoodsEntitiesZero");
//                        if (distributerGoodsEntitiesZero.size() == 1) {
//                            GbDistributerGoodsEntity disGoodsEntity = distributerGoodsEntitiesZero.get(0);
//
//                            ordersEntity.setGbDoDisGoodsId(disGoodsEntity.getGbDistributerGoodsId());
...
//                            for (GbDistributerGoodsEntity distributerGoods : distributerGoodsEntitiesZero) {
//                                GbDistributerGoodsEntity distributerGoodsEntity = gbDistributerGoodsService.queryObject(distributerGoods.getGbDistributerGoodsId());
//                                list.add(distributerGoodsEntity);
//                            }
//                            ordersEntity.setGbDistributerGoodsEntityList(list);
//                            returnList.add(aaaTemp(ordersEntity));
//                        }
//
//                    }
...
//                        System.out.println("depDigidid" + nxDdgDisGoodsId + "enndnt" + distributerGoodsEntity.getGbDistributerGoodsId());
//                        ordersEntity.setGbDoDepDisGoodsId(nxDepartmentDisGoodsEntity.getGbDepartmentDisGoodsId());
//                        ordersEntity.setGbDoDisGoodsId(distributerGoodsEntity.getGbDistributerGoodsId());
//                        returnList.add(saveOneOrder(ordersEntity, distributerGoodsEntity));
//
//
//                    }else{
...
//                        //
//                        List<GbDistributerGoodsEntity> list = new ArrayList<>();
//                        for (GbDepartmentDisGoodsEntity departmentDisGoodsEntity : departmentDisGoodsEntitiesFirst) {
//                            Integer nxDdgDisGoodsId = departmentDisGoodsEntity.getGbDdgDisGoodsId();
//                            GbDistributerGoodsEntity distributerGoodsEntity = gbDistributerGoodsService.queryObject(nxDdgDisGoodsId);
//                            list.add(distributerGoodsEntity);
//                        }
//                        ordersEntity.setGbDistributerGoodsEntityList(list);
...
//    @RequestMapping(value = "/depPasteSearchGoods1", method = RequestMethod.POST)
//    @ResponseBody
//    public R depPasteSearchGoods1(@RequestBody List<GbDepartmentOrdersEntity> orderList) {
//        List<GbDepartmentOrdersEntity> returnList = new ArrayList<>();
//        for (GbDepartmentOrdersEntity ordersEntity : orderList) {
//
//            if (ordersEntity.getGbDoRemark().equals("-1")) {
...
//            mapZero.put("searchStr", goodsName);
//            mapZero.put("standard", ordersEntity.getGbDoStandard());
//            mapZero.put("depId", ordersEntity.getGbDoDepartmentId());
//            System.out.println("mapzreororororor111zzzizizizi" + mapZero);
//            List<GbDistributerGoodsEntity> distributerGoodsEntitiesZero = gbDistributerGoodsService.queryDisGoodsByName(mapZero);
...
//                mapOne.put("disId", ordersEntity.getGbDoDistributerId());
//                mapOne.put("searchStr", goodsName);
//                mapOne.put("depId", ordersEntity.getGbDoDepartmentId());
//                List<GbDistributerGoodsEntity> distributerGoodsEntitiesOne = gbDistributerGoodsService.queryDisGoodsByLikeName(mapOne);
...
//                                        List<GbDepartmentDisGoodsEntity> nxDepartmentDisGoodsEntityList = gbDepartmentDisGoodsService.queryDepartmentGoods(mapDep);
...
//                                            GbDepartmentDisGoodsEntity departmentDisGoodsEntity = nxDepartmentDisGoodsEntityList.get(0);
//                                            GbDistributerGoodsEntity distributerGoodsEntity = gbDistributerGoodsService.queryDisGoodsDetail(departmentDisGoodsEntity.getGbDdgDisGoodsId());
//                                            returnList.add(saveOneOrder(ordersEntity, distributerGoodsEntity));
//                                        } else {
//                                            List<GbDistributerGoodsEntity> list = new ArrayList<>();
//                                            for (GbDepartmentDisGoodsEntity departmentDisGoodsEntity : nxDepartmentDisGoodsEntityList) {
//                                                Integer nxDdgDisGoodsId = departmentDisGoodsEntity.getGbDdgDisGoodsId();
//
//                                                GbDistributerGoodsEntity distributerGoodsEntity = gbDistributerGoodsService.queryObject(nxDdgDisGoodsId);
//                                                list.add(distributerGoodsEntity);
...
//                                        GbDistributerGoodsEntity disGoodsEntity = distributerGoodsEntitiesA.get(0);
//
//                                        GbDistributerGoodsEntity distributerGoodsEntity = gbDistributerGoodsService.queryDisGoodsDetail(disGoodsEntity.getGbDistributerGoodsId());
//                                        returnList.add(saveOneOrder(ordersEntity, distributerGoodsEntity));
//
//                                    } else {
//                                        ordersEntity.setGbDistributerGoodsEntityList(distributerGoodsEntitiesA);
...
//                        //1 保存订单
//                        GbDistributerGoodsEntity disGoodsEntity = distributerGoodsEntitiesOne.get(0);
//                        GbDistributerGoodsEntity distributerGoodsEntity = gbDistributerGoodsService.queryDisGoodsDetail(disGoodsEntity.getGbDistributerGoodsId());
//                        returnList.add(saveOneOrder(ordersEntity, distributerGoodsEntity));
//
//                    } else {
...
//                        List<GbDepartmentDisGoodsEntity> nxDepartmentDisGoodsEntityList = gbDepartmentDisGoodsService.queryDepartmentGoods(map);
//                        if (nxDepartmentDisGoodsEntityList.size() == 0) {
//
//                            ordersEntity.setGbDistributerGoodsEntityList(distributerGoodsEntitiesOne);
//                            returnList.add(aaaTemp(ordersEntity));
...
//                    map.put("name", ordersEntity.getGbDoGoodsName());
//                    System.out.println("chaxunxdepGoods" + map);
//                    List<GbDepartmentDisGoodsEntity> gbDepartmentDisGoodsEntities = gbDepartmentDisGoodsService.queryDepDisGoodsByParams(map);
//                    if (gbDepartmentDisGoodsEntities.size() == 1) {
//                        GbDepartmentDisGoodsEntity nxDepartmentDisGoodsEntity = gbDepartmentDisGoodsEntities.get(0);
//                        GbDistributerGoodsEntity distributerGoodsEntity = gbDistributerGoodsService.queryDisGoodsDetail(nxDepartmentDisGoodsEntity.getGbDdgDisGoodsId());
//                        returnList.add(saveOneOrder(ordersEntity, distributerGoodsEntity));
//                    } else {
//                        ordersEntity.setGbDistributerGoodsEntityList(distributerGoodsEntitiesZero);
//                        returnList.add(aaaTemp(ordersEntity));
//                    }
//
//                }
...
//                List<GbDistributerFatherGoodsEntity> purchaseToday = gbDpgService.queryGreatGrandPurGoodsDetail(map44);
                List<GbDistributerFatherGoodsEntity> purchaseToday = gbDpgService.queryGbFatherDisPurchaseGoods(map44);
...
//
    ...
    public R saveOrdersGbJj(@RequestBody GbDepartmentOrdersEntity gbDepartmentOrders) {
        ...
        if (purchaseGoodsEntities.size() == 0) {
            ...
            gbPurchaseGoodsEntity.setGbDpgPurchaseNxSupplierId(gbDistributerGoodsEntity.getGbDgGbSupplierId());
            gbPurchaseGoodsEntity.setGbDpgDisGoodsGrandId(gbDistributerGoodsEntity.getGbDgDfgGoodsGrandId());
            System.out.println("grandiid" + gbDistributerGoodsEntity.getGbDgDfgGoodsGrandId() + "greatttid" + gbDistributerGoodsEntity.getGbDgDfgGoodsGreatId());
            gbPurchaseGoodsEntity.setGbDpgDisGoodsGreatId(gbDistributerGoodsEntity.getGbDgDfgGoodsGreatId());
            System.out.println("nxididid" + gbDepartmentOrders.getGbDoNxDistributerId());
            gbDistributerPurchaseGoodsService.save(gbPurchaseGoodsEntity);
...
//
    ...
    private Map<String, Object> autoAddPurchaseBatch(GbDepartmentOrdersEntity ordersEntity, GbDistributerGoodsEntity goodsEntity) {
        ...
        if (entities.size() == 0) {
            ...
            if(nxJrdhSupplierEntity.g() != null){
