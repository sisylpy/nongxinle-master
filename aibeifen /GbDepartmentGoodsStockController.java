...
//        }
    ...
    public R getDepGoodsFreshEveryDay(String startDate, String stopDate, Integer depGoodsId) {
        ...
        for (int i = 0; i < howManyDaysInPeriod + 1; i++) {
            ...
            reteList.add(new BigDecimal(freshRate).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
...
//                        grandFather.setFatherGoodsEntities(fatherGoodsEntities);
    ...
    public R getMendianStockTypePeriod(Integer disId, Integer whichDay, String searchDepIds, String searchDepId) {
        ...
        if (idsGb != null) {
            for (String depId : idsGb) {
                ...
                mapDep.put("depFatherId", departmentEntity.getGbDepartmentId());
                System.out.println("kkkkksubsbbsbsbsbbs" + mapDep);
                Integer integerDep = gbDepGoodsStockService.queryGoodsStockCount(mapDep);
                double depTotal = 0.0;
                if (integerDep > 0) {
                    depTotal = gbDepGoodsStockService.queryDepGoodsRestTotal(mapDep);
                }
                departmentEntity.setDepStockSubtotalString(new BigDecimal(depTotal).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
    ...
    private List<GbDistributerFatherGoodsEntity> queryWhichDayPeriodData(Integer disId, Integer whichDay) {

        Map<String, Object> mapRen1 = new HashMap<>();
        mapRen1.put("disId", disId);
        mapRen1.put("dayuStatus", -1);
        if (whichDay != -1) {
            mapRen1.put("date", formatWhatDay(-whichDay));
        }

        mapRen1.put("restWeight", 0);


        Map<String, Object> mapRen1W = new HashMap<>();
        mapRen1W.put("disId", disId);
        mapRen1W.put("dayuStatus", -1);
        if (whichDay != -1) {
            mapRen1W.put("date", formatWhatDay(-whichDay));
        }
        mapRen1W.put("restWeight", 0);

        Double oneTotal = 0.0;
        Integer integer1 = gbDepGoodsStockService.queryGoodsStockCount(mapRen1);
        List<GbDistributerFatherGoodsEntity> recentlyStockOne = new ArrayList<>();
        if (integer1 > 0) {
            recentlyStockOne = getStockGoodsFatherRestSubTotal(mapRen1, oneTotal, mapRen1W);
        }
        return recentlyStockOne;
    ...
    private Map<String, Object> getFreshRateGoods(String startDate, String stopDate, Integer goodsFatherId, Integer depId) {
        ...
        if (howManyDaysInPeriod > 0) {
            ...
            for (int i = 0; i < howManyDaysInPeriod + 1; i++) {
                ...
                if (count > 0) {
                    ...
                    Tv = v / count;
                    costList.add(new BigDecimal(Tv).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
                } else {
                    costList.add("0");
                }
            }
        ...
        if (integer > 0) {
            ...
            for (GbDistributerGoodsEntity distributerGoodsEntity : distributerGoodsEntities) {
                ...
                distributerGoodsEntity.setGoodsFreshRateString(new BigDecimal(Tv).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            }
        } else {
            return R.error(-1, "dd");
        }
    ...
    private List<GbDistributerFatherGoodsEntity> getStockFatherGoodsRestSubtotal
        ...
        for (GbDistributerFatherGoodsEntity greatGrandFather : treeSet) {
            ...
            for (GbDistributerFatherGoodsEntity grandFather : grandGoodsEntities) {
                ...
                BigDecimal grandWasteValue = new BigDecimal(0);
                double grandTotal = 0.0;
                map0.put("disGoodsGrandId", grandFather.getGbDistributerFatherGoodsId());
                System.out.println("shibshisisis" + map0);
                Integer integer = gbDepGoodsStockService.queryGoodsStockCount(map0);
                if (integer > 0) {
                    ...
                    map0W.put("disGoodsGrandId", grandFather.getGbDistributerFatherGoodsId());

                    System.out.println("wasteesser" + map0W);
                    Integer integerW = gbDepGoodsStockService.queryGoodsStockCount(map0W);
                    Double wasteTotal = 0.0;
                    if (integerW > 0) {
                        wasteTotal = gbDepGoodsStockService.queryDepGoodsWasteTotal(map0W);
                    }
                    grandWasteValue = new BigDecimal(wasteTotal).setScale(1, BigDecimal.ROUND_HALF_UP);
                }
                ...
                grandFather.setFatherWasteTotalString(grandWasteValue.toString());
            }

            BigDecimal divide = new BigDecimal(0);
            if (!new BigDecimal(total).equals(BigDecimal.ZERO)) {
                divide = greatGrandTotal.divide(new BigDecimal(total), 2, BigDecimal.ROUND_HALF_UP).multiply(new BigDecimal(100)).setScale(1, BigDecimal.ROUND_HALF_UP);
            }
    ...
    private Map<String, Object> getWasteTypeGoods(String startDate, String stopDate, Integer goodsFatherId,
        ...
        if (integer > 0) {
            ...
            for (GbDistributerGoodsEntity distributerGoodsEntity : distributerGoodsEntities) {
                ...
                distributerGoodsEntity.setGoodsWasteRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            }
        } else {
            return R.error(-1, "e");
        }
    ...
    private Map<String, Object> getLossTypeGoods(String startDate, String stopDate, Integer goodsFatherId,
        ...
        if (integer > 0) {
            ...
            for (GbDistributerGoodsEntity distributerGoodsEntity : distributerGoodsEntities) {
                ...
                distributerGoodsEntity.setGoodsLossRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            }
        } else {
            return R.error(-1, "me");
        }
    ...
    private Map<String, Object> getSalesTypeGoods(String startDate, String stopDate, Integer goodsFatherId,
        ...
        if (integer > 0) {
            ...
            for (GbDistributerGoodsEntity distributerGoodsEntity : distributerGoodsEntities) {
                ...
                distributerGoodsEntity.setGoodsSalesRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            }
        } else {
            return R.error(-1, "mei");
        }
    ...
    private Map<String, Object> getFreshRateGoodsDep(String startDate, String stopDate, Integer disGoodsId,
        ...
        if (integer > 0) {
            ...
            for (GbDepartmentEntity departmentEntity : departmentEntities) {
                ...
                departmentEntity.setDepFreshRateString(new BigDecimal(Tv).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            }
        } else {
            return R.error(-1, "没有数据");
        }
    ...
    private Map<String, Object> getWasteTypeGoodsDep(String startDate, String stopDate, Integer disGoodsId,
        ...
        if (integer > 0) {
            ...
            for (GbDepartmentEntity departmentEntity : departmentEntities) {
                ...
                departmentEntity.setDepWasteRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            }
        } else {
            return R.error(-1, "m");
        }
    ...
    private Map<String, Object> getLossTypeGoodsDep(String startDate, String stopDate, Integer disGoodsId,
        ...
        if (integer > 0) {
            ...
            for (GbDepartmentEntity departmentEntity : departmentEntities) {
                ...
                departmentEntity.setDepLossRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            }
        } else {
            return R.error(-1, "m");
        }
    ...
    private Map<String, Object> getSalesTypeGoodsDep(String startDate, String stopDate, Integer disGoodsId,
        ...
        if (integer > 0) {
            ...
            for (GbDepartmentEntity departmentEntity : departmentEntitiesS) {
                ...
                departmentEntity.setDepSalesRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            }
        } else {
            return R.error(-1, "e");
        }
    ...
    private Map<String, Object> getCostTypeGoodsDep(String startDate, String stopDate, Integer disGoodsId) {
        ...
        if (integer > 0) {
            ...
            for (GbDepartmentEntity departmentEntity : departmentEntities) {
                ...
                departmentEntity.setDepCostRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            }
        }
            ...
            for (GbDistributerFatherGoodsEntity greatGrand : greatGrandGoodsEntities) {
                ...
                for (GbDistributerFatherGoodsEntity grand : grandGoodsEntities) {
                    ...
                    for (GbDistributerFatherGoodsEntity father : fatherGoodsEntities) {
                        ...
                        father.setFatherCostRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
                    ...
                    grand.setFatherCostRateString(new BigDecimal(vg).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
                ...
                greatGrand.setFatherCostRateString(new BigDecimal(vgg).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
...
//        Double produceWeightTotalT = gbDepGoodsStockService.queryDepStockProduceWeightTotal(map);
            ...
            for (GbDistributerFatherGoodsEntity greatGrand : greatGrandGoodsEntities) {
                ...
                for (GbDistributerFatherGoodsEntity grand : grandGoodsEntities) {
                    ...
                    for (GbDistributerFatherGoodsEntity father : fatherGoodsEntities) {
                        ...
                        father.setFatherSalesRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
                    ...
                    grand.setFatherSalesRateString(new BigDecimal(vg).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
                ...
                greatGrand.setFatherSalesRateString(new BigDecimal(vgg).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            }
        }
        ...
        mapResult.put("salesRate", new BigDecimal(vTS).setScale(1, BigDecimal.ROUND_HALF_UP));
        mapResult.put("lossRate", new BigDecimal(vTL).setScale(1, BigDecimal.ROUND_HALF_UP));
        mapResult.put("wasteRate", new BigDecimal(vTW).setScale(1, BigDecimal.ROUND_HALF_UP));
        mapResult.put("code", "0");
            ...
            for (GbDistributerFatherGoodsEntity greatGrand : greatGrandGoodsEntities) {
                ...
                for (GbDistributerFatherGoodsEntity grand : grandGoodsEntities) {
                    ...
                    for (GbDistributerFatherGoodsEntity father : fatherGoodsEntities) {
                        ...
                        father.setFatherLossRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
                    ...
                    grand.setFatherLossRateString(new BigDecimal(vg).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
                ...
                greatGrand.setFatherLossRateString(new BigDecimal(vgg).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
            ...
            for (GbDistributerFatherGoodsEntity greatGrand : greatGrandGoodsEntities) {
                ...
                for (GbDistributerFatherGoodsEntity grand : grandGoodsEntities) {
                    ...
                    for (GbDistributerFatherGoodsEntity father : fatherGoodsEntities) {
                        ...
                        father.setFatherWasteRateString(new BigDecimal(v).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
                    ...
                    grand.setFatherWasteRateString(new BigDecimal(vg).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
                ...
                greatGrand.setFatherWasteRateString(new BigDecimal(vgg).setScale(1, BigDecimal.ROUND_HALF_UP).toString());
...
//exceed Period
    ...
    @ResponseBody
    public R disGetDayStockByGreatId(Integer disId, String searchDepId, String greatId) {
        Map<String, Object> map = new HashMap<>();

        map.put("in", disGetStockDayStockByGreatId(disId, searchDepId, greatId, 0));
        map.put("one", disGetStockDayStockByGreatId(disId, searchDepId, greatId, -1));
        map.put("two", disGetStockDayStockByGreatId(disId, searchDepId, greatId, -2));
        map.put("three", disGetStockDayStockByGreatId(disId, searchDepId, greatId, -3));
        map.put("exceedThree", disGetStockDayStockByGreatId(disId, searchDepId, greatId, -4));
    ...
    private Map<String, Object> disGetStockDayStockByGreatId(Integer disId, String searchDepId, String greatId, Integer which) {
        List<GbDepartmentGoodsStockEntity> stockEntityListIn = new ArrayList<>();
        Map<String, Object> result = new HashMap<>();
        double total = 0.0;
        Map<String, Object> map = new HashMap<>();
...
//    @ResponseBody
//    public R getEveryGoodsStockJingjing(Integer goodsFatherId, Integer which, String subDepId, String searchDepId) {
//        Map<String, Object> map = new HashMap<>();
//        if (which == 99) {
//            map = getGoodsStockPeriodAllJingjing(goodsFatherId, searchDepId, subDepId);
//        } else {
//            map = getGoodsStockPeriodJingjing(goodsFatherId, which, searchDepId, subDepId);
//        }
//        return R.ok().put("data", map);
//    }
    ...
    public R getDisGoodsOrderDayJingjinig(Integer disGoodsId, String startDate, String stopDate, Integer depId, Integer searchDepIds) {
        ...
        if (howManyDaysInPeriod > 0) {
            for (int i = 0; i < howManyDaysInPeriod + 1; i++) {
                ...
                if (count > 0) {
                    System.out.println("coudndndhdnddd" + count);
                    System.out.println("orderemapapa?????????caoniamamamam" + mapDisGoods);
...
//                businessEntity.setGbBusinessResultWeight(weightData.setScale(1, BigDecimal.ROUND_HALF_UP));
//                resultData.add(businessEntity);
//            }
//        }
//
...
//                    gbBusinessWeight = stockWeight.add(new BigDecimal(resultData.get(i).getGbBusinessWeight())).setScale(1, BigDecimal.ROUND_HALF_UP);
//                } else {
//                    gbBusinessWeight = stockWeight.subtract(new BigDecimal(resultData.get(i).getGbBusinessWeight())).setScale(1, BigDecimal.ROUND_HALF_UP);
//                }
...
//        map.put("dayuFreshTime", formatWhatYearDayTime(0));
        ...
        if (integer > 0) {
            ...
            BigDecimal result = new BigDecimal(aDouble).setScale(1, BigDecimal.ROUND_HALF_UP);
...
//        map2.put("notDayuStopDate", stopDate);
        ...
        if (integer2 > 0) {
            ...
            BigDecimal resultx = new BigDecimal(aDoublex).setScale(1, BigDecimal.ROUND_HALF_UP);
            ...
            for (int j = 0; j < wb.getNumberOfSheets(); j++) {
                ...
                for (int i = 1; i <= lastRowNum; i++) {
                    ...
                    System.out.println("iiiiii===" + goodsId + "fatherid==" + goodsFatherId + "quantity" + quantity
                            + "price==" + price);
                    BigDecimal subtotal = new BigDecimal(quantity).multiply(new BigDecimal(price)).setScale(1, BigDecimal.ROUND_HALF_UP);
...
//        判断是否价格异常商品
        ...
        if (gbDisGoodsEntity.getGbDgControlFresh() != null && gbDisGoodsEntity.getGbDgControlFresh() == 1) {
            ...
            String gbDpgWarnFullTime = formatWhatFullTime(warnHour);
            ...
            try {
                ...
                if (gbDpgWarnFullTime != null && !gbDpgWarnFullTime.trim().isEmpty()) {
    ...
    private GbDistributerPurchaseGoodsEntity checkPurGoodsPrice(GbDistributerPurchaseGoodsEntity purchaseGoodsEntity) {
        ...
        if (buyPrice.compareTo(goodsHighest) == 1 && purchaseGoodsEntity.getGbDpgBuyQuantity() != null) { //高于最高价
            ...
            BigDecimal highertotal = higherWhatPrice.multiply(weight).setScale(1, BigDecimal.ROUND_HALF_UP); //高出的单价部分 * 重量
        ...
        if (buyPrice.compareTo(goodsLowest) == -1 && purchaseGoodsEntity.getGbDpgBuyQuantity() != null) { //低于最低价
            ...
            BigDecimal lowerTotal = lowerWhatPrice.multiply(weight).setScale(1, BigDecimal.ROUND_HALF_UP);
...
//                    return i1;
    ...
    private GbDepartmentGoodsStockReduceEntity changeDepartmentStock(GbDepartmentGoodsStockEntity stock, String what) {
        ...
        if (what.equals("loss")) {
            ...
            myChangeSubtotal = myChangeWeight.multiply(costPrice).setScale(1, BigDecimal.ROUND_HALF_UP); //总损耗成本
        ...
        if (what.equals("produce")) {
            ...
            myChangeSubtotal = myChangeWeight.multiply(costPrice).setScale(1, BigDecimal.ROUND_HALF_UP); //总制作成本
        ...
        if (what.equals("waste")) {
            ...
            BigDecimal produceSubtotal = produceWeight.multiply(costPrice).setScale(1, BigDecimal.ROUND_HALF_UP); //总制作成本
        ...
        if (depGoodsDailyEntity != null) {
            ...
            if (what.equals("produce")) {
                ...
                if (!stock.getGbDgsSellingPrice().equals("-1")) {
                    ...
                    BigDecimal myChangeProfitSubtotal = new BigDecimal(stock.getGbDgsBetweenPrice()).multiply(myChangeWeight).setScale(1, BigDecimal.ROUND_HALF_UP);
...
//        }
    ...
    private void saveReturnDepGoodsStock(GbDepartmentGoodsStockEntity stock, Integer orderId, Integer purId) {
        ...
        if (fromStock != null) {
            BigDecimal multiply = bigDecimal.multiply(bigDecimal1).setScale(1, BigDecimal.ROUND_HALF_UP);
            GbDepartmentGoodsStockEntity stockEntity = new GbDepartmentGoodsStockEntity();
    ...
    private GbDepartmentOrdersEntity saveRetrunOrder(GbDepartmentGoodsStockEntity stock, Integer returnId) {
        ...
        Integer gbDgsGbDisGoodsId = stock.getGbDgsGbDisGoodsId();
        GbDistributerGoodsEntity goodsEntity = disGoodsService.queryObject(gbDgsGbDisGoodsId);
        Integer nxGoodsId = goodsEntity.getGbDgNxGoodsId();
        ...
        if (goodsEntity.getGbDgGoodsType().equals(getGbDisGoodsTypeJicai()) || goodsEntity.getGbDgGoodsType().equals(getGbDisGoodsTypeZicai())
            ...
            disGoods.setGbDpgOrdersWeightAmount(1);
        ...
        if (stock.getGbDgsNxSupplierId() != -1) {
            ...
            GbDistributerPurchaseGoodsEntity purchaseGoodsEntity = gbDistributerPurchaseGoodsService.queryObject(purchaseGoodsId);
            purchaseGoodsEntity.setGbDpgPurchaseType(21);
        ...
        if (stock.getGbDgsPurUserId() != null) {
            ...
            StringBuilder pathBuilder = new StringBuilder("pages/management/purGoodsStars/purGoodsStars");
    ...
    private void autoAddPurchaseBatch(GbDepartmentOrdersEntity ordersEntity, GbDepartmentGoodsStockEntity stock) {
        ...
        Map<String, Object> map = new HashMap<>();
        map.put("disId", gbDistributerEntity.getGbDistributerId());
        map.put("admin", 2);
        List<GbDepartmentUserEntity> userEntities = gbDepartmentUserService.queryDepUsersByDepIdAndAdmin(map);
        if (userEntities.size() > 0) {
